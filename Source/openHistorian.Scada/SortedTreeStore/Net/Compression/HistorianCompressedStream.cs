...
{
    public class ScadaCompressedStream
        : KeyValueStreamCompressionBase<ScadaKey, ScadaValue>
    {
        ...
        public override Guid CompressionType
        {
            get
            {
                return CreateScadaCompressedStream.TypeGuid;
            }
        }
        ...
        public override void Encode(BinaryStreamBase stream, ScadaKey currentKey, ScadaValue currentValue)
        {
        ...
        public override unsafe int Encode(byte* stream, ScadaKey currentKey, ScadaValue currentValue)
        {
            int size = 0;
            if (currentKey.Timestamp == m_prevTimestamp
             && ((currentKey.PointID ^ m_prevPointID) < 64)
        ...
        public override unsafe bool TryDecode(BinaryStreamBase stream, ScadaKey key, ScadaValue value)
        {
