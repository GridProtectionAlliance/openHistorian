...
namespace GSF.SortedTreeStore.Net.Compression
{
    public unsafe class HistorianPointCollection
        : PointCollectionBase<ScadaKey, ScadaValue>
    {
        ...
        public override void UnDequeue(ScadaKey key, ScadaValue value)
        {
        ...
        public override void Peek(ScadaKey key)
        {
            if (IsEmpty)
                throw new Exception();
            fixed (byte* lp = RawData)
        ...
        public override void Enqueue(ScadaKey key, ScadaValue value)
        {
            if (IsFull)
                throw new Exception();
            fixed (byte* lp = RawData)
        ...
        public override void Dequeue(ScadaKey key, ScadaValue value)
        {
            if (IsEmpty)
                throw new Exception();
            fixed (byte* lp = RawData)
        ...
        public override int CompareTo(PointCollectionBase<ScadaKey, ScadaValue> other)
        {
        ...
        public override int CompareTo(ScadaKey other)
        {
            if (IsEmpty)
                return 1;
            fixed (byte* leftPtr = &RawData[DequeuePosition])
        ...
        /// </returns>
        public override bool CopyToWhileLessThan(PointCollectionBase<ScadaKey, ScadaValue> destination, ScadaKey comparer)
        {
        ...
        public override bool CopyToIfLessThan(PointCollectionBase<ScadaKey, ScadaValue> destination, ScadaKey comparer)
        {
            if (IsEmpty)
                throw new Exception();
            if (destination.IsFull)
        ...
        public override void CopyTo(PointCollectionBase<ScadaKey, ScadaValue> destination)
        {
            if (IsEmpty)
                throw new Exception();
            if (destination.IsFull)
