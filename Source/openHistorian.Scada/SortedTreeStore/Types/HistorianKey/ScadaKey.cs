...
namespace openHistorian.Collections
{
    ...
    /// </summary>
    public class ScadaKey
        : EngineKeyBase<ScadaKey>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ScadaKey Clone()
        {
            ScadaKey key = new ScadaKey();
        ...
        public override SortedTreeKeyMethodsBase<ScadaKey> CreateKeyMethods()
        {
