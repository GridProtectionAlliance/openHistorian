...
{
    public class KeyMethodsScadaKey
        : SortedTreeKeyMethodsBase<ScadaKey>
    {
        ...
        public override void Clear(ScadaKey key)
        {
            key.Timestamp = 0;
            key.PointID = 0;
            key.EntryNumber = 0;
        ...
        public override void SetMin(ScadaKey key)
        {
        ...
        public override void SetMax(ScadaKey key)
        {
        ...
        public override int CompareTo(ScadaKey left, ScadaKey right)
        {
        ...
        public override bool IsLessThan(ScadaKey left, ScadaKey right)
        {
            if (left.Timestamp != right.Timestamp)
        ...
        public override bool IsLessThanOrEqualTo(ScadaKey left, ScadaKey right)
        {
            //if (left.Timestamp != right.Timestamp)
            //    return left.Timestamp < right.Timestamp;
            //if (left.PointID != right.PointID)
        ...
        public override unsafe void Write(byte* stream, ScadaKey data)
        {
        ...
        public override unsafe void Read(byte* stream, ScadaKey data)
        {
