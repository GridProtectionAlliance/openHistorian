...
namespace openHistorian.Collections
{
    ...
    /// </summary>
    public class ScadaValue
        : ISortedTreeValue<ScadaValue>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public bool IsEqualTo(ScadaValue other)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ScadaValue Clone()
        {
            ScadaValue value = new ScadaValue();
            value.Value1 = Value1;
            value.Value2 = Value2;
            value.Value3 = Value3;
            return value;
        ...
        /// </summary>
        /// <returns></returns>
        public ScadaValueStruct ToStruct()
        {
            return new ScadaValueStruct
                {
                    Value1 = Value1,
                    Value2 = Value2,
                    Value3 = Value3
        ...
        public SortedTreeValueMethodsBase<ScadaValue> CreateValueMethods()
        {
