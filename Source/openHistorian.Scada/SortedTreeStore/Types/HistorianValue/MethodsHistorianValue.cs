...
namespace openHistorian.Collections
{
    internal class ValueMethodsHistorianValue
        : SortedTreeValueMethodsBase<ScadaValue>
    {
        ...
        public override unsafe void Write(byte* stream, ScadaValue data)
        {
        ...
        public override void WriteCompressed(BinaryStreamBase stream, ScadaValue currentValue, ScadaValue previousValue)
        {
        ...
        public override void ReadCompressed(BinaryStreamBase stream, ScadaValue currentValue, ScadaValue previousValue)
        {
        ...
        public override void Clear(ScadaValue data)
        {
            data.Value1 = 0;
            data.Value2 = 0;
            data.Value3 = 0;
        ...
        public override unsafe void Read(byte* stream, ScadaValue data)
        {
        ...
        public override unsafe void Copy(ScadaValue source, ScadaValue destination)
        {
