...
namespace GSF.SortedTreeStore.Tree.TreeNodes
{
    ...
    /// </summary>
    public unsafe class ScadaCompressionTsScanner
        : EncodedNodeScannerBase<ScadaKey, ScadaValue>
    {
        int m_nextOffset;
        ...
        public ScadaCompressionTsScanner(byte level, int blockSize, BinaryStreamBase stream, Func<ScadaKey, byte, uint> lookupKey)
        ...
        public override bool ReadWhile(ScadaKey key, ScadaValue value, ScadaKey upperBounds)
        {
        ...
        protected override void InternalPeek(ScadaKey key, ScadaValue value)
        {
            byte* stream = Pointer + m_nextOffset;
            uint code = stream[0];
            //Compression Stages:
        ...
        protected override void InternalRead(ScadaKey key, ScadaValue value)
        {
            byte* stream = Pointer + m_nextOffset;
            int size;
            uint code = stream[0];
        ...
        protected override bool InternalRead(ScadaKey key, ScadaValue value, KeyMatchFilterBase<ScadaKey> filter)
        {
            byte* stream = Pointer + m_nextOffset;
            int totalSize = 0;
        ...
        protected override bool InternalReadWhile(ScadaKey key, ScadaValue value, ScadaKey upperBounds)
        {
            byte* stream = Pointer + m_nextOffset;
            int size;
            uint code = stream[0];
        ...
        protected override bool InternalReadWhile(ScadaKey key, ScadaValue value, ScadaKey upperBounds, KeyMatchFilterBase<ScadaKey> filter)
        {
        TryAgain:
            byte* stream = Pointer + m_nextOffset;
            int size;
