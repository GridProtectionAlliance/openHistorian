...
namespace GSF.IO.Unmanaged
{
        ...
        : BinaryStreamBase
    {
            ...
            : base()
        {
            ...
            m_current = stream;
            m_first = stream;
            m_lastRead = stream + length;
            m_lastWrite = stream + length;
        }
        ...
        public override long Position
        {
            ...
            set
            {
                ...
                {
                    throw new Exception("Navigated outside the valid range");
                }
            }
        }
        ...
        public override BinaryStreamBase CloneStream()
        {
            ...
            return new BinaryStreamPointerWrapper(m_first, (int)(m_lastPosition - m_firstPosition));
        }
