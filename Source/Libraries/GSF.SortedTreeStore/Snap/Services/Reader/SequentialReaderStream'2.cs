...
namespace GSF.Snap.Services.Reader
{
        ...
        where TValue : SnapTypeBase<TValue>, new()
    {
        ...
        private bool m_keyMatchIsUniverse;

        private SeekFilterBase<TKey> m_keySeekFilter;
        private MatchFilterBase<TKey, TValue> m_keyMatchFilter;

        private TimeoutOperation m_timeout;
        private List<BufferedArchiveStream<TKey, TValue>> m_tablesOrigList;
        private CustomSortHelper<BufferedArchiveStream<TKey, TValue>> m_sortedArchiveStreams;
