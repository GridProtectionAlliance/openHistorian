...
{
    public class EngineStreamFilter<TKey, TValue>
        ...
        where TValue : class, ISortedTreeValue<TValue>, new()
    {
        ...
        public EngineStreamFilter(KeyMatchFilterBase<TKey> keyMatchFilter)
        {
        ...
        {
            m_count++;
            return (m_count & 1023) == 0 || m_keyMatchFilter.Contains(key);
        }
    }
}
