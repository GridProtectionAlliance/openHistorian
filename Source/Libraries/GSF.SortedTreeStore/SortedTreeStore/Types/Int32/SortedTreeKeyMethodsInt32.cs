...
{
    public class SortedTreeKeyMethodsInt32
        : SortedTreeTypeMethods<SortedTreeInt32>
    {

        public override unsafe int BinarySearch(byte* pointer, SortedTreeInt32 key2, int recordCount, int keyValueSize)
        {
