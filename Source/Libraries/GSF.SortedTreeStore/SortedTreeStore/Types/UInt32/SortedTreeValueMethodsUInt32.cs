...
namespace GSF.SortedTreeStore.Types
{
        ...
        : SortedTreeValueMethodsBase<SortedTreeUInt32>
    {
        ...
        public override void ReadCompressed(BinaryStreamBaseOld stream, SortedTreeUInt32 currentKey, SortedTreeUInt32 previousKey)
        {
            currentKey.Value = stream.Read7BitUInt32() ^ previousKey.Value;
        }
        public override void WriteCompressed(BinaryStreamBaseOld stream, SortedTreeUInt32 currentKey, SortedTreeUInt32 previousKey)
        {
