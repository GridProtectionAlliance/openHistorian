...
//            Encoding7Bit.Write(stream, ref size, currentKey.EntryNumber ^ prevKey.EntryNumber);
//            Encoding7Bit.Write(stream, ref size, currentValue.Value1 ^ prevValue.Value1);
//            Encoding7Bit.Write(stream, ref size, currentValue.Value2 ^ prevValue.Value2);
//            Encoding7Bit.Write(stream, ref size, currentValue.Value3 ^ prevValue.Value3);
//            return size;
//        }
...
//        {
//            int position = 0;
//            currentKey.Timestamp = prevKey.Timestamp ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            currentKey.PointID = prevKey.PointID ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            currentKey.EntryNumber = prevKey.EntryNumber ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            currentValue.Value1 = prevValue.Value1 ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            currentValue.Value2 = prevValue.Value2 ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            currentValue.Value3 = prevValue.Value3 ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            return position;
//        }
...
//        public override unsafe SortedTreeScannerBase<HistorianKey, HistorianValue> CreateTreeScanner()
//        {
