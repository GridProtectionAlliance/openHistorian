...
//            int position = 0;
//            key.Timestamp = m_prevTimestamp ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            key.PointID = m_prevPointId ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            key.EntryNumber = m_prevEntryNumber ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            value.Value1 = m_prevValue1 ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            value.Value2 = m_prevValue2 ^ Encoding7Bit.ReadUInt64(stream, ref position);
//            value.Value3 = m_prevValue3 ^ Encoding7Bit.ReadUInt64(stream, ref position);
