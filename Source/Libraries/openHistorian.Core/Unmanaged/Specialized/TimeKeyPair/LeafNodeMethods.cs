...
//        int m_lastIndex;
//        long m_lastSearchKeyTime;
//        long m_lastSearchKeyKey;
//        bool m_currentlyScanning;
//        short m_childCount;
//        uint m_nextNodeIndex;
//        long m_currentPostion;
//        long m_lastPositionInNode;
...
//            if (m_currentNode != nodeIndex || (isForWriting && !m_currentNodeSupportsWrite))
//            {
...
//                int currentIndex;
//                int validLength;
//                if (!m_stream.GetRawDataBlock(isForWriting, out buffer, out currentIndex, out validLength))
...
//        bool SeekToKey(long keyTime, long keyKey, byte* lp, out int offset)
//        {
//            byte level = *lp;
...
//                if (SeekToKey(keyTime, keyKey, lpp, out offset)) //If found
//                    return false;
...
//        bool GetValue(uint nodeIndex, long keyTime, long keyKey)
//        {
//            m_stream.Position = nodeIndex * m_blockSize;
...
//            {
//                byte* lpp = lp + currentIndex;
//                if (SeekToKey(keyTime, keyKey, lpp, out offset))
//                {
...
//        bool GetStartingPosition(uint nodeIndex, long keyTime, long keyKey)
//        {
//            m_stream.Position = nodeIndex * m_blockSize;
...
//        public void PrepareForTableScan(KeyType firstKey, KeyType lastKey)
//        {
//            m_lastSearchKeyKey = lastKey.Key;
//            m_lastSearchKeyTime = lastKey.Time.Ticks;

//            throw new NotImplementedException();
//        }

//        public bool GetNextKeyTableScan(out KeyType key)
//        {
//            throw new NotImplementedException();
//        }
