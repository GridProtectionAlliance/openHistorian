...
//            while (true)
//            {
//                switch ((DefinePointsCommands)m_host.Stream.ReadByte())
//                {
...
//                        referenceNumber = (int)m_host.Stream.Read7BitUInt32();
...
//                        referenceNumber = (int)m_host.Stream.Read7BitUInt32();
//                        pointId = m_host.Stream.ReadGuid();
//                        if (m_localPoints.ContainsKey(referenceNumber))
//                        {
...
//            while (true)
//            {
//                switch ((ArchivePointsCommands)m_host.Stream.ReadByte())
//                {
//                    case ArchivePointsCommands.Done:
//                        return;
//                    case ArchivePointsCommands.Archive:
//                        int referenceNumber = m_host.Stream.ReadInt32();
//                        long pointId = m_pointMapping[referenceNumber];
//                        long time = m_host.Stream.ReadInt64();
//                        long value1 = m_host.Stream.ReadInt64();
//                        long value2 = m_host.Stream.ReadInt64();
//                        if (pointId >= 0)
