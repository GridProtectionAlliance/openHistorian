...
//        public ProcessClientStream(BinaryStreamBase clientStream, HistorianEngine engine)
//        {
//            m_engine = engine;
//            m_connected = true;
//            m_routingTable = new ITransportCommand[256];

//            m_stream = clientStream;
...
//        public BinaryStreamBase Stream
//        {
//            get
//            {
//                return m_stream;
...
//            while (m_connected)
//            {
//                byte nextCommand = m_stream.ReadByte();
