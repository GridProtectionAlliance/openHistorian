...
//                            return;
//                        case 1:
//                            curValue2 = curValue2 + ((code & 7u) | ((ulong)StreamLeaf.ReadByte() << 3));
//                            return;
//                        case 2:
//                            curValue2 = curValue2 + ((code & 7u) | ((ulong)StreamLeaf.ReadUInt16() << 3));
//                            return;
//                        case 3:
//                            curValue2 = curValue2 + ((code & 7u) | ((ulong)StreamLeaf.ReadUInt24() << 3));
//                            return;
//                        case 4:
//                            curValue2 = curValue2 + ((code & 7u) | ((ulong)StreamLeaf.ReadUInt32() << 3));
//                            return;
//                        case 5:
//                            curValue2 = curValue2 + ((code & 7u) | ((ulong)StreamLeaf.ReadUInt40() << 3));
//                            return;
//                        case 6:
//                            curValue2 = curValue2 + ((code & 7u) | ((ulong)StreamLeaf.ReadUInt48() << 3));
//                            return;
//                    }
//                    if ((code & 4) == 0)
//                    {
//                        curValue2 = curValue2 + ((code & 3u) | ((ulong)StreamLeaf.ReadUInt56() << 2));
//                        return;
//                    }
//                    else
//                    {
//                        curValue2 = (ulong)StreamLeaf.ReadUInt64();
//                        return;
//                    }
//                }
//                else
...
//            else
//            {
//                curKey1 ^= StreamLeaf.Read7BitUInt64();
//                curKey2 ^= StreamLeaf.Read7BitUInt64();
//                curValue1 ^= StreamLeaf.Read7BitUInt64();
//                curValue2 ^= StreamLeaf.Read7BitUInt64();
//                return;
//            }
//        }
//    }
