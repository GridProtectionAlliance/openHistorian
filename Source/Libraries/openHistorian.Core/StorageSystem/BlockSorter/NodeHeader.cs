...
namespace Historian.StorageSystem.BlockSorter
{
    ...
    struct NodeHeader
    {
        ...
        public NodeHeader(TreeHeader header, uint nodeIndex)
            : this()
        {
            Load(header, nodeIndex);
        }

        public void Load(TreeHeader header, uint nodeIndex)
        {
            header.Stream.Position = header.BlockSize * nodeIndex;
            Load(header.Stream);
        }
        ...
        public void Save(TreeHeader header, uint nodeIndex)
        {
            header.Stream.Position = header.BlockSize * nodeIndex;
            Save(header.Stream);
        }
