...
namespace openHistorian.Core.StorageSystem
{
    ...
    public interface ISupportsBinaryStream
    {
        ...
        void GetCurrentBlock(bool isWriting, out byte[] buffer, out int firstIndex, out int lastIndex, out int currentIndex);
        /// <summary>
        ...
        int Read(byte[] data, int start, int count);
        /// <summary>
        ...
        void Write(byte[] data, int start, int count);
        /// <summary>
