...
namespace openHistorian.Collections
{
        ...
        : TreeKeyMethodsBase<TreeUInt32>
    {
        ...
        public override void ReadCompressed(BinaryStreamBase stream, TreeUInt32 currentKey, TreeUInt32 previousKey)
        {
            currentKey.Value = stream.Read7BitUInt32() ^ previousKey.Value;
        }
        public override void WriteCompressed(BinaryStreamBase stream, TreeUInt32 currentKey, TreeUInt32 previousKey)
        {
