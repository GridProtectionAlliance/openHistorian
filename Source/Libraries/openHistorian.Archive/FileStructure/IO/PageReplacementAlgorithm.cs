...
namespace openHistorian.FileStructure.IO
{
    ...
    /// </remarks>
    public class PageReplacementAlgorithm : IDisposable
    {
        #region [ Members ]
        ...
        /// </summary>
        List<PageLock> m_arrayIndexLocks;
        ...
        public PageReplacementAlgorithm(BufferPool pool)
        {
        ...
        public PageLock GetPageLock()
        {
            ...
            foreach (var pageLock in m_arrayIndexLocks)
            {
