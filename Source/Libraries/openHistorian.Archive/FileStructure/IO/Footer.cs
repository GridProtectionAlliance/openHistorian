...
namespace openHistorian.FileStructure.IO
{
    ...
    unsafe internal class Footer
    {
        const int ChecksumIsNotComputed = 0;
        const int ChecksumIsValid = 1;
        const int ChecksumIsNotValid = 2;
        const int ChecksumMustBeRecomputed = 3;
