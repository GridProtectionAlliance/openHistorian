...
namespace openHistorian.Archives.V1
{
    ...
    public class ArchiveFileAllocationTable : ISupportBinaryImage
    {
        ...
        private class VariableTableRegion : ISupportBinaryImage
        {
            ...
            public int BinaryLength
            {
                get
                {
                    ...
                    return (ArrayDescriptorLength + (m_parent.m_dataBlockCount * ArchiveDataBlockPointer.ByteCount));
                }
            }
        ...
        /// <summary>
        /// Gets or sets the number <see cref="ArchiveData"/>s received by the <see cref="ArchiveFile"/> for archival.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the number <see cref="ArchiveData"/>s archived by the <see cref="ArchiveFile"/>.
        /// </summary>
        /// <exception cref="ArgumentException">The value being assigned is not positive or zero.</exception>
        ...
        /// <summary>
        /// Initializes <see cref="ArchiveFileAllocationTable"/> from the specified <paramref name="buffer"/>.
        /// </summary>
        /// <param name="buffer">Binary image to be used for initializing <see cref="ArchiveFileAllocationTable"/>.</param>
        /// <param name="startIndex">0-based starting index of initialization data in the <paramref name="buffer"/>.</param>
        /// <param name="length">Valid number of bytes in <paramref name="buffer"/> from <paramref name="startIndex"/>.</param>
        /// <returns>Number of bytes used from the <paramref name="buffer"/> for initializing <see cref="ArchiveFileAllocationTable"/>.</returns>
        ...
        /// <summary>
        /// Returns the first <see cref="ArchiveDataBlock"/> in the <see cref="ArchiveFile"/> for the specified <paramref name="key"/>.
        /// </summary>
        /// <param name="key">Historian identifier whose <see cref="ArchiveDataBlock"/> is to be retrieved.</param>
        ...
        public ArchiveDataBlock FindDataBlock(int key, bool preRead = true)
        {
            ArchiveDataBlockPointer pointer;

            lock (m_dataBlockPointers)
            {
                pointer = m_dataBlockPointers.FirstOrDefault(dataBlockPointer => dataBlockPointer.Key == key);
            }
        ...
        /// <summary>
        /// Returns the last <see cref="ArchiveDataBlock"/> in the <see cref="ArchiveFile"/> for the specified <paramref name="key"/>.
        /// </summary>
        /// <param name="key">Historian identifier.</param>
        /// <param name="preRead">true to pre-read data to locate write cursor.</param>
        /// <returns><see cref="ArchiveDataBlock"/> object if a match is found; otherwise null.</returns>
        public ArchiveDataBlock FindLastDataBlock(int key, bool preRead = true)
        {
            ArchiveDataBlockPointer pointer;

            lock (m_dataBlockPointers)
            {
                pointer = m_dataBlockPointers.LastOrDefault(dataBlockPointer => dataBlockPointer.Key == key);
            }
        ...
        /// <summary>
        /// Returns all <see cref="ArchiveDataBlock"/>s in the <see cref="ArchiveFile"/> for the specified <paramref name="key"/>.
        /// </summary>
        /// <param name="key">Historian identifier.</param>
        /// <param name="preRead">true to pre-read data to locate write cursor.</param>
        /// <returns>A collection of <see cref="ArchiveDataBlock"/>s.</returns>
        public List<ArchiveDataBlock> FindDataBlocks(int key, bool preRead = true)
        {
            return FindDataBlocks(key, TimeTag.MinValue, preRead);
        }

        /// <summary>
        /// Returns all <see cref="ArchiveDataBlock"/>s in the <see cref="ArchiveFile"/> for the specified <paramref name="key"/> with <see cref="ArchiveData"/> points later than the specified <paramref name="startTime"/>.
        /// </summary>
        /// <param name="key">Historian identifier.</param>
        /// <param name="startTime">Start <see cref="TimeTag"/>.</param>
        /// <param name="preRead">true to pre-read data to locate write cursor.</param>
        /// <returns>A collection of <see cref="ArchiveDataBlock"/>s.</returns>
        public List<ArchiveDataBlock> FindDataBlocks(int key, TimeTag startTime, bool preRead = true)
        {
            return FindDataBlocks(key, startTime, TimeTag.MaxValue, preRead);
        }

        /// <summary>
        /// Returns all <see cref="ArchiveDataBlock"/>s in the <see cref="ArchiveFile"/> for the specified <paramref name="key"/> with <see cref="ArchiveData"/>s between the specified <paramref name="startTime"/> and <paramref name="endTime"/>.
        /// </summary>
        /// <param name="key">Historian identifier.</param>
        /// <param name="startTime">Start <see cref="TimeTag"/>.</param>
        ...
        /// <param name="preRead">true to pre-read data to locate write cursor.</param>
        /// <returns>A collection of <see cref="ArchiveDataBlock"/>s.</returns>
        public List<ArchiveDataBlock> FindDataBlocks(int key, TimeTag startTime, TimeTag endTime, bool preRead = true)
        {
            ...
            lock (m_dataBlockPointers)
            {
                ...
                blockPointers = m_dataBlockPointers.FindAll(dataBlockPointer => dataBlockPointer.Matches(key, startTime, endTime));
                ...
                if (!(startTime == TimeTag.MinValue || endTime == TimeTag.MaxValue))
                {
                    ...
                    ArchiveDataBlockPointer borderMatch = m_dataBlockPointers.LastOrDefault(dataBlockPointer => dataBlockPointer.Matches(key, TimeTag.MinValue, searchEndTime));
                    if (borderMatch != null)
        ...
        /// <summary>
        /// Returns an <see cref="ArchiveDataBlock"/> for writing <see cref="ArchiveData"/>s for the specified <paramref name="key"/>.
        /// </summary>
        /// <param name="key">Historian identifier for which the <see cref="ArchiveDataBlock"/> is being requested.</param>
        /// <param name="dataTime"><see cref="TimeTag"/> of the <see cref="ArchiveData"/> to be written to the <see cref="ArchiveDataBlock"/>.</param>
        /// <param name="blockIndex"><see cref="ArchiveDataBlock.Index"/> of the <see cref="ArchiveDataBlock"/> last used for writting <see cref="ArchiveData"/>s for the <paramref name="key"/>.</param>
        ...
        internal ArchiveDataBlock RequestDataBlock(int key, TimeTag dataTime, int blockIndex)
        {
            ...
            if (blockIndex >= 0 && blockIndex < m_dataBlockCount)
            {
                ...
                if (!dataBlockPointer.IsAllocated && dataBlock.SlotsUsed > 0)
                {
                    ...
                    dataBlock.Reset();
                         ...
                         (dataBlockPointer.Key != key ||
                          (dataBlockPointer.Key == key && dataBlock.SlotsAvailable == 0)))
                {
            ...
            if (blockIndex < 0)
            {
                ...
                dataBlock = FindLastDataBlock(key);
            ...
            if (dataBlockPointer != null && !dataBlockPointer.IsAllocated)
            {
                ...
                lock (m_parent.FileData)
                {
                    ...
                    m_parent.FileData.Seek(DataLength + ArrayDescriptorLength + (dataBlockPointer.Index * ArchiveDataBlockPointer.ByteCount), SeekOrigin.Begin);
