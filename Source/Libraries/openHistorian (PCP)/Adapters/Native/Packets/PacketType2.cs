...
namespace openHistorian.Adapters.Native.Packets
{
    ...
    /// </summary>
    public class PacketType2 : PacketBase, IData
    {
        // **************************************************************************************************
        // *                                        Binary Structure                                        *
        // **************************************************************************************************
        ...
        public TimeTag Time
        {
            get
            {
                return new TimeTag(new DateTime(m_year, m_month, m_day, m_hour + m_gmtOffset, m_minute, m_second, m_millisecond, DateTimeKind.Utc));
            }
            set
            {
