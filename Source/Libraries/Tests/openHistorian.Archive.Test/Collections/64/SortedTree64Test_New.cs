...
//{
//    [TestFixture]
//    public class SortedTree64Test_New
//    {
...
//        public void TestSortedTreeRandom(uint count, bool clip = false)
//        {
//            StepTimer.Reset();
...
//                    StepTimer.ITimer timer = StepTimer.Start("RandomNumbers");
//                    for (uint x = 0; x < count; x++)
//                    {
//                        random.Next();
//                        if ((x & 4095) == 0)
...
//            SB.Append((count / (StepTimer.GetAverage("Read") - StepTimer.GetAverage("RandomNumbers")) / 1000000).ToString("0.000\t"));
//            SB.Append((count / (StepTimer.GetAverage("Write") - StepTimer.GetAverage("RandomNumbers")) / 1000000).ToString("0.000\t"));
...
//        //        swScan.Start();
//        //        var scan = treeStruct.GetTreeScanner();
//        //        scan.SeekToKey(0);
//        //        while (scan.Read())
//        //            ;
//        //        swScan.Stop();
