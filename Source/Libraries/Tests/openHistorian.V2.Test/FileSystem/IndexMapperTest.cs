...
namespace openHistorian.V2.FileSystem
{
    ...
    public class IndexMapperTest
    {
        ...
        public static void TestSpeed()
        {
            ...
            long page = (long)ArchiveConstants.LastAddressableBlockIndex * ArchiveConstants.DataBlockDataLength;
        ...
        public static void TestMethod1()
        {
            ...
            long lastAddress = Math.Min((long)int.MaxValue * ArchiveConstants.DataBlockDataLength, ArchiveConstants.LastAddressableBlockIndex * (long)ArchiveConstants.DataBlockDataLength);
