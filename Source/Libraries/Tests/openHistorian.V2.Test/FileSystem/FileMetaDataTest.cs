...
namespace openHistorian.V2.FileSystem
{
    ...
    public class FileMetaDataTest
    {
        ...
        public void Test()
        {
            ...
            FileMetaData node = new FileMetaData(fileIdNumber, fileExtension, AccessMode.ReadWrite);
        ...
        private static FileMetaData SaveItem(FileMetaData node)
        {
            ...
            stream.Position = 0;
            //load the header
            FileMetaData node2 = new FileMetaData(new BinaryReader(stream), AccessMode.ReadOnly);
        ...
        static internal void CheckEqual(FileMetaData RO, FileMetaData RW)
        {
        ...
        static internal bool AreEqual(FileMetaData a, FileMetaData b)
        {
            if (a == null || b == null)
                return false;
