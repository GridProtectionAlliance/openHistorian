...
namespace GSF.Threading.Test
{
    ...
    public class WorkerThreadTest
    {
        ...
        {
            int count = 0;
            var worker = new WorkerThread(Callback, false, ThreadPriority.Normal);
        ...
        private class NestedDispose
        {
            ...
            {
                worker = new WorkerThread(Callback, false, ThreadPriority.Normal);
            }
        ...
        public void Test()
        {
            using (var work = new WorkerThread(Callback, false, ThreadPriority.Normal))
            {
                work.Start();
                Thread.Sleep(100);
                work.Start(10);
        ...
        public void TestSignalRate()
        {
            ...
            sw.Start();
            using (var work = new WorkerThread(Callback2, false, ThreadPriority.Normal))
            {
