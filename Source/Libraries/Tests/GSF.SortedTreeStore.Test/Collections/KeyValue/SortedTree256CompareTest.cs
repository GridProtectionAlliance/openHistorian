...
//            var tree1 = SortedTree256.Create(bs1, 4096);
//            var tree2 = SortedTree256.Create(bs2, 4096, CompressionMethod.DeltaEncoded);
//            var tree3 = SortedTree256.Create(bs3, 4096, CompressionMethod.TimeSeriesEncoded);
