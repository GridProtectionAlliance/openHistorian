...
namespace GSF.Snap.Tree
{
    ...
    public class FixedSizeNodeTest
    {
        ...
        {
            SortedTreeNodeBase<SnapUInt32, SnapUInt32> tree = Library.SortedTreeNodes.CreateTreeNode<SnapUInt32, SnapUInt32>(EncodingDefinition.FixedSizeCombinedEncoding, 0);
        ...
        {
            var tree = Library.SortedTreeNodes.CreateTreeNode<SnapUInt32, SnapUInt32>(EncodingDefinition.FixedSizeCombinedEncoding, 0);
