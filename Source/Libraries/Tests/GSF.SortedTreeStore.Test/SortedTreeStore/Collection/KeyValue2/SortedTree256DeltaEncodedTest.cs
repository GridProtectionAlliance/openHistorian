...
//    {
//        static KeyValuePair256 kvp1 = new KeyValuePair256();
//        static KeyValuePair256 kvp2 = new KeyValuePair256();
...
//                {
//                    kvp1.Set(key1, key2, value1, value2);
//                    kvp2.Set(prevKey1, prevKey2, prevValue1, prevValue2);
//                    length = base.EncodeRecord(lp, kvp1, kvp2);
...
//                base.DecodeNextRecord(kvp2);
//                prevKey1 = kvp2.Key1;
//                prevKey2 = kvp2.Key2;
//                prevValue1 = kvp2.Value1;
//                prevValue2 = kvp2.Value2;
