...
//    {
//        public static void BenchmarkTree(Func<SortedTree256> initializer, uint pointCount)
//        {
//            int seed = 1235213452;
...
//        static double GetSequential(SortedTree256 tree, ulong firstPoint, ulong count)
//        {
//            Stopwatch sw = new Stopwatch();
//            sw.Start();
//            ulong v1, v2;
...
//        static double ScanTree(SortedTree256 tree)
//        {
//            Stopwatch sw = new Stopwatch();
//            sw.Start();
...
//        static double GetReverseSequential(SortedTree256 tree, ulong lastPoint, ulong count)
//        {
//            Stopwatch sw = new Stopwatch();
//            sw.Start();
//            ulong v1, v2;
...
//        static double GetRandom(SortedTree256 tree, int seed, uint count)
//        {
//            Random r = new Random(seed);
//            Stopwatch sw = new Stopwatch();
//            sw.Start();
