...
namespace openVisN
{
    ...
    public class SignalDefinition
    {
        ...
        public SignalDefinition(SignalType signalType, ulong pointIds)
            : this(signalType, new ulong[] { pointIds })
        {
        }
    ...
    {
        public SignalProduct(SignalType signalType, ulong pointId1, ulong pointId2)
            : base(signalType, new ulong[] { pointId1, pointId2 })
        {
        }
    ...
    public class SignalWatt : SignalDefinition
    {
        ...
        public SignalWatt(SignalType signalType, ulong voltageMagnitudePointId, ulong voltageAnglePointId, ulong currentMagnitudePointId, ulong currentAnglePointId)
            : base(signalType, new ulong[] { voltageMagnitudePointId, voltageAnglePointId, currentMagnitudePointId, currentAnglePointId })
        {
        }
