...
//    /// </summary>
//    internal class TransactionalBlocking
//    {
...
//        /// <summary>
//        /// To be called by anything that is making changes to a transaction. 
//        /// This call will then release anything blocking on this transaction
//        /// expecting it to occur. 
//        /// </summary>
//        /// <param name="isMemoryAction">determines if these actions are memory base transactions or file based transactions. </param>
//        /// <param name="onCommit">occurs when data has been committed.</param>
//        /// <param name="onRollover"></param>
//        public void OnChange(bool isMemoryAction, long onCommit, long onRollover)
//        {
