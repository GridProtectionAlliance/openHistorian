...
namespace openHistorian.DataServices
{
    ...
    /// <MetadataRecord Key="1" DataType="0" Name="TVA_CORD-BUS2:ABBV" Synonym1="4-PM1" Synonym2="VPHM" Synonym3="" Description="Cordova ABB-521 500 kV Bus 2 Positive Sequence Voltage Magnitude" HardwareInfo="ABB RES521" 
    ...
    public class SerializableMetadataRecord
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="MetadataRecord.Key"/>.
        /// </summary>
        ...
        {
            MetadataRecord metadataRecord = new MetadataRecord(Key);
