...
namespace openHistorian.Archives.V1
{
    ...
    /// <see cref="MetadataRecordSummary"/> is sent back as a reply to <see cref="PacketType3"/> and  <see cref="PacketType4"/>.
    /// </summary>
    ...
    public class MetadataRecordSummary : ISupportBinaryImage
    {
        ...
        /// <summary>
        /// Same as <see cref="MetadataRecord.Key"/>.
        /// </summary>
        ...
        public int ParseBinaryImage(byte[] buffer, int startIndex, int length)
        {
            if (length >= ByteCount)
            {
                ...
                Key = EndianOrder.LittleEndian.ToInt32(buffer, startIndex + 0);
