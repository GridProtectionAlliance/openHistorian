...
//        void Authenticate()
//        {
//            if (m_host.Stream.ReadGuid() != m_applicationId)
//            {
//                m_host.Stream.Write((byte)0); //Wrong Application
//                //m_host.Stream.Flush();
//                m_host.Terminate();
//                m_connected = false;
//                return;
...
//            m_host.Stream.Read(clientChallenge, 0, 20);
//            m_host.Stream.Write((byte)1); //authentication successful

//            if (m_authenticated)
//            {
//                m_host.Stream.Write((byte)0); //RevokeCount
//                m_host.Stream.Write((byte)0); //GrantCount
//                //m_host.Stream.Flush();
//            }
//            else
//            {
...
//                m_host.Stream.Write((byte)0); //RevokeCount
//                m_host.Stream.Write((byte)2); //GrantCount
//                m_host.Stream.Write(command1.CommandCode); //GrantCount
//                m_host.Stream.Write(command2.CommandCode); //GrantCount
//                //m_host.Stream.Flush();
//            }
