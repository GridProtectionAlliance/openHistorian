    ...
    public abstract class ExporterBase : IExporter
    {
        ...
        protected DataSet GetExportDataAsDataset(Export export, string dataTableName)
        {
            ...
            foreach (string listenerName in exportData.Keys)
            {
                ...
                {
                    result.Tables[0].Rows.Add(listenerName, dataPoint.HistorianID, dataPoint.Time.ToString(), dataPoint.Value, dataPoint.Flags);
                }
            }
        ...
        ///     <item>
        ///         <term>Quality</term>
        ///         <description><see cref="IDataPoint.Flags"/> of the time-series data.</description>
        ///     </item>
        /// </list>
