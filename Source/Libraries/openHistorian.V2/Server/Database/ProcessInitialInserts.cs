...
namespace openHistorian.V2.Server.Database
{
    ...
    /// </summary>
    class ProcessInitialInserts : IDisposable
    {
        ...
        public ProcessInitialInserts(ResourceEngine resources, int autoComitCount)
        {
            m_newPointQueue = new InboundPointQueue(autoComitCount);
            m_newPointQueue.SetQueueCallback(SignalInitialInsert);
        ...
        public InboundPointQueue NewPointQueue
        {
            get
            {
                return m_newPointQueue;
            }
        }

        /// <summary>
        /// This process fires 10 times per second and populates the most current archive file.
        /// </summary>
