//******************************************************************************************************
//  DiskIoSessionExtension.cs - Gbtc
//
...
namespace openHistorian.V2.FileSystem
{
    unsafe internal static class DiskIoSessionExtension
    {
        ...
        public static void Read(this DiskIoSession diskIoSession, int blockIndex, BlockType blockType, int indexValue, int fileIdNumber, int snapshotSequenceNumber, byte[] destination)
        {
            ...
            Marshal.Copy(diskIoSession.IntPtr, destination, 0, ArchiveConstants.BlockSize);
        }
        ...
        public static void WriteToExistingBlock(this DiskIoSession diskIoSession, int blockIndex, BlockType blockType, int indexValue, int fileIdNumber, int snapshotSequenceNumber, byte[] data)
        {
            ...
            Marshal.Copy(data, 0, diskIoSession.IntPtr, ArchiveConstants.BlockSize);
        ...
        public static void WriteZeroesToNewBlock(this DiskIoSession diskIoSession, int blockIndex, BlockType blockType, int indexValue, int fileIdNumber, int snapshotSequenceNumber)
        {
            diskIoSession.BeginWriteToNewBlock(blockIndex);
            Memory.Clear(diskIoSession.Pointer, diskIoSession.Length);
            diskIoSession.EndWrite(blockType, indexValue, fileIdNumber, snapshotSequenceNumber);
        }
