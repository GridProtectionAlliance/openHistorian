...
//        /// </summary>
//        void InternalNodeSplitNode(uint childNodeIndex)
//        {
...
//                InternalNodeInsert(childNodeIndex);
//            }
//            else
//            {
...
//            }
//            CopyKey3ToKey2();
//            NodeWasSplit(origionalNode.Level, currentNode, greaterNodeIndex);
...
//        public void InternalNodeInsert(uint childNodeIndex)
//        {
//            int offset;
...
//            {
//                InternalNodeSplitNode(childNodeIndex);
//                return;
//            }

//            if (InternalNodeSeekToKey(out offset))
...
//        /// <returns></returns>
//        public uint InternalNodeGetNodeIndex()
//        {
//            int offset;
//            if (InternalNodeSeekToKey(out offset))
//            {
...
//        protected virtual bool InternalNodeSeekToKey(out int offset)
//        {
...
//        public uint InternalNodeCreateEmptyNode(byte level, uint childNodeBefore, uint childNodeAfter)
//        {
