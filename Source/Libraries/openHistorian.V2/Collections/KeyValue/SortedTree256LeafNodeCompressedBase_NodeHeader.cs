//******************************************************************************************************
//  SortedTree256LeafNodeCompressedBase_NodeHeader.cs - Gbtc
//
...
{
    public abstract partial class SortedTree256LeafNodeCompressedBase
    {
        ...
        struct NodeHeader
        {
            ...
            public static void Save(IBinaryStream stream, int validBytes, long leftSiblingNodeIndex, long rightSiblingNodeIndex)
            {
                stream.Write((byte)0);
                stream.Write(validBytes);
                stream.Write(leftSiblingNodeIndex);
