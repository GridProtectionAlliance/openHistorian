//******************************************************************************************************
//  SortedTree256InternalNodeBase.cs - Gbtc
//
...
{
    public abstract partial class SortedTree256InternalNodeBase : SortedTree256Base
    {
        #region [ Members ]
        ...
        protected SortedTree256InternalNodeBase(IBinaryStream stream)
            : base(stream)
        {
            Initialize();
        }

        protected SortedTree256InternalNodeBase(IBinaryStream stream, int blockSize)
