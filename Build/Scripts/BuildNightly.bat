...
@ECHO OFF
"C:\Program Files (x86)\MSBuild\14.0\Bin\MSBuild.exe" openHistorian.buildproj /p:SkipHelpFiles=true /l:FileLogger,Microsoft.Build.Engine;logfile=openHistorian.output