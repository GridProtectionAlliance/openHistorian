...
@ECHO OFF
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\msbuild.exe openHistorian.buildproj /p:ForceBuild=true /l:FileLogger,Microsoft.Build.Engine;logfile=openHistorian.output
PAUSE